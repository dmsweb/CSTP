...

{
    ...
    {   
        ...
        if($userConnect->getRoles()[0]==="ROLE_ADMIN" && $subject->getRoles()[0] != "ROLE_SECRETAIRE" ){
            return true;
        }
        //dd($userConnect);
        ...
        switch ($attribute) {
            case 'POST':   
                if($userConnect->getRoles()[0]==="ROLE_SECRETAIRE"){
                    return true;
                }else if($userConnect->getRoles()[0]==="ROLE_EMPLOYE"){
            ...
            case 'POST_VIEW':
                ...
                if($userConnect->getRoles()[0]==="ROLE_EMPLOYE"){
